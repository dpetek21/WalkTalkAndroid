...
class FriendEventsAdapter(val eventList: List<Event>) : RecyclerView.Adapter<FriendEventsAdapter.FriendEventsHolder>() {
    inner class FriendEventsHolder(view : View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FriendEventsHolder {
        val friendEventsView = LayoutInflater
            .from(parent.context)
            .inflate(R.layout.event_list_item, parent, false)
        return FriendEventsHolder(friendEventsView)
    }
    ...
    override fun onBindViewHolder(holder: FriendEventsHolder, position: Int) {
